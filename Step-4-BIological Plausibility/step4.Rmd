...
```
### Loading data
We load data set from Step 1:probes_subjects that contains DNA methylation probe values, subjects_genes that contains gene expression values, and probes_genes_distance that is a sparse matrix containing the distances between a gene and a probe.Note that probes_genes_distance is 0 when probe and gene distance is over 1Mb.
```{r}
