...
**[Step 4: Biological Plausability](https://github.com/STAT540-UBC/Repo_team_Gene_Heroes/tree/master/Step-4-BIological%20Plausibility)** - This directory includes the visualizations and explanation behind biological reasonings and gene enrichment analysis. __For gene enrichment analysis and the analysis of spatial pattern of methylation probes, Sina contributed in the research and idea in addition to collaboration with Zohreh on coding part, and Zohreh contributed in the coding and writting aspect of the them.__
